...
public:
	...
	virtual void Save(ofstream& OutFile, Type obj) = 0;	// Saves the GameObject parameters to the file
	virtual void Load(ifstream& Infile, Type obj) = 0;	// Loads and Reads the GameObject parameters from the file
