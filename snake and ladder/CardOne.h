...
class CardOne :	public Card
{
	...
	static bool flag; // To be sure that the card dose not read parameters more than once
public:
	...
	virtual void Load(ifstream& Infile, Type obj);                                                 // by decrementing the player's wallet by the walletAmount data member
